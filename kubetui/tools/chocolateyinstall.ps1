...
$url        = 'https://github.com/sarub0b0/kubetui/releases/download/v1.5.0/kubetui-x86_64-pc-windows-msvc-rustls.exe' # download url, HTTPS preferred
...
#   softwareName  = 'kubetui.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
